...
export interface ThePool extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
  ...
  methods: {
    ...
    swapAForB(
      amountAIn: number | string | BN,
      amountBOut: number | string | BN
    ): NonPayableTransactionObject<void>;
    ...
    swapBForA(
      amountBIn: number | string | BN,
      amountAOut: number | string | BN
    ): NonPayableTransactionObject<void>;
